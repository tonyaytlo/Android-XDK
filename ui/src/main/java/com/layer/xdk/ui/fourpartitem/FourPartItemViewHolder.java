...
public class FourPartItemViewHolder<ITEM extends Queryable, VIEW_MODEL extends FourPartItemViewModel<ITEM>> extends ItemViewHolder<ITEM, VIEW_MODEL, XdkUiFourPartItemBinding, FourPartItemStyle> {
