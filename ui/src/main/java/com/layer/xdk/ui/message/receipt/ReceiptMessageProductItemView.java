...
import com.layer.xdk.ui.databinding.UiReceiptMessageProductDetailBinding;
...
public class ReceiptMessageProductItemView extends FrameLayout {
    private UiReceiptMessageProductDetailBinding mBinding;
    ...
    public ReceiptMessageProductItemView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBinding = UiReceiptMessageProductDetailBinding.inflate(inflater, this, true);
    }
    ...
    public void setProductModel(ProductMessageModel productModel) {
        ...
        if (subtitle != null) {
            String text = getContext().getString(R.string.ui_receipt_product_detail_options, subtitle);
            ...
            String quantity = productModel.getMetadata().getQuantity() > 0 ?
                    getContext().getString(R.string.ui_receipt_product_detail_quantity,
